...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h3 class="m-0 font-weight-bold text-primary">Tambah Tanda Kehormatan</h3>
    </div>
    <div class="card-body">
        <form action="{{ route('store.tanda-kehormatan') }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('post')
            ...
            <div class="form-group">
                ...
                <input type="text" name="tanda_kehormatan" class="form-control @error('tanda_kehormatan') is-invalid @enderror" value="{{ old('tanda_kehormatan') }}">
            ...
            <div class="form-group">
                ...
                <input type="number" name="tmt" class="form-control @error('tmt') is-invalid @enderror" value="{{ old('tmt') }}">
                @error('tmt')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
